...
const getModelCacheKey = (
	...
	`${width}_${polynomial}_${initialVal}_${xorOut}_${
		inputReflected ? "in" : "no"
	}_${outputReflected ? "out" : "no"}`;
	...
	if (!Object.prototype.hasOwnProperty.call(modelCache, key)) {
		...
		switch (width) {
			...
			case 64:
				...
				castMask = new Uint64(0xffffffff, 0xffffffff);
				break;
			default:
