...
export default (
	...
	mat4.rotate(modelViewMatrix, modelViewMatrix, Math.PI / 8, [1, 0, 0]); // axis to rotate around (Z)

	mat4.rotate(modelViewMatrix, modelViewMatrix, cubeRotation, [0, 1, 0]); // axis to rotate around (X)
