...
import Logo from "../assets/devek_text_white.svg?react";
...
const Home = () => (
  <Page>
    ...
    <footer>
      <strong>Developed & Hosted</strong> with <span className="emoji">❤</span> by{" "}
      <a href="https://github.com/elisherer">elisherer</a>
    </footer>
  </Page>
);
